 ...
 */
class FooterSocial extends Abstract_Component {

	const COMPONENT_ID = 'footer_social';
	const LINK_ID      = 'link_setting';
	const FOOTER_SOCIAL_ID  = 'footer_social_setting';
	...
	public function init() {
		...
		$this->set_property( 'section', 'footer_social' );
	...
	public function add_settings() {
		SettingsManager::get_instance()->add(
			[
				'id'                 => self::FOOTER_SOCIAL_ID,
				'group'              => $this->get_class_const( 'COMPONENT_ID' ),
				'tab'                => SettingsManager::TAB_GENERAL,
				'transport'          => 'post' . $this->get_class_const( 'COMPONENT_ID' ),
				'sanitize_callback'  => 'wp_filter_nohtml_kses',
				'default'            => 'linkedin,twitter,youtube,telegram,,,,,#,#,#,#,linkedin,twitter,youtube,telegram',
				'label'              => __( 'Social', 'solace' ),
				'type'               => '\Solace\Customizer\Controls\React\FooterSocial',
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.facebook svg',
					],
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.youtube svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.twitter svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.tiktok svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.telegram svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.pinterest svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.linkedin svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.instagram svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.threads svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social.whatsapp svg',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
		...
		SettingsManager::get_instance()->add(
			[
				...
				'type'               => '\Solace\Customizer\Controls\React\FooterSocial2',
				'section'            => $this->section,
				'use_dynamic_fields' => array( 'string' ),
			]
		);
		...
		SettingsManager::get_instance()->add(
			[
				...
				'live_refresh_css_prop' => [
					'cssVar' => [
						'vars'     => 'fill',
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social',
					],
					'selector' => '.builder-item--' . $this->get_id(),
				],
			]
			...
			[
				...
				'live_refresh_css_prop' => array(
					'cssVar'  => [
						...
						'selector' => '.builder-item--' . $this->get_id() . ' .component-wrap-footer-social .box-social svg',
						'suffix'   => 'px',
					],
					'type'    => 'svg-icon-size',
					'default' => 22,
	...
	public function render_component() {
		Main::get_instance()->load( 'components/component-footer-social' );
	}
}
